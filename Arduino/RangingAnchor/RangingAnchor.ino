    ...
    if (receivedAck) {
        ...
        if (msgId == POLL) {
            ...
            if (!protocolFailed) {
                ...
                //  ranging counter                                                 Distance (M)                                    RXP(dBm)                                             Sampling rate (Hz)                                                   FP(dBm)                                                   RecQuality (dBm) Serial.print(" "); Serial.println(DW1000.getFirstPathPower());
                Serial.print(distance); Serial.print(" "); Serial.print(DW1000.getReceivePower()); Serial.print(" "); Serial.println(samplingRate); //Serial.print(" "); Serial.println(DW1000.getReceiveQuality());
                successRangingCount++;
